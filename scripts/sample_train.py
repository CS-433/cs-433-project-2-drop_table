...
root = "C:\\Users\\Eva.DESKTOP-21K26HC\\Documents\\machine learning\\lcd"
...
while size < 100:
    ...
    # img = Image.fromarray(sample[0]['color']*255, 'RGB')
    # #°img.show()

    # img = Image.fromarray(sample[1]['color']*255, 'RGB')
    # #img.show()
